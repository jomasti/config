...
if jms#IsPlugged('neosnippet')
  " Snippets userdir
  let g:neosnippet#snippets_directory = g:jms#vim_dir . '/snippets'
...
if jms#IsPlugged('vim-better-javascript-completion')
...
if executable('npm')
  ...
  if executable('tern') && jms#IsPlugged('tern_for_vim')
  ...
  if executable('tern') && (
        \ jms#IsPlugged('tern_for_vim') || jms#IsPlugged('deoplete-ternjs')
        \ )
...
if jms#IsPlugged('jspc.vim')
  autocmd jmscompletion FileType javascript setlocal completefunc=jspc#omni
...
if jms#IsPlugged('neocomplete')
  let g:neocomplete#data_directory =
        \ expand(g:jms#vim_dir . '/.tmp/neocomplete')
  ...
  call jms#InitDict('g:neocomplete#sources#omni#functions')
  ...
  call jms#InitDict('g:neocomplete#force_omni_input_patterns')
  call extend(g:neocomplete#force_omni_input_patterns, s:fip)

  " Patterns that use neocomplete
  call jms#InitDict('g:neocomplete#sources#omni#input_patterns')
...
if jms#IsPlugged('deoplete.nvim')
  ...
  " Patterns that bypass to &omnifunc
  call jms#InitDict('g:deoplete#omni_patterns')
  call extend(g:deoplete#omni_patterns, s:fip)

  " Completion engine input patterns
  call jms#InitDict('g:deoplete#omni#input#patterns')
